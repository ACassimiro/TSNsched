...
public class IncrementalScenario {
	public void runTestCase(){
		...
		*/
		...
		Device dev1 = new  Device(200, 0, 1000, 1625);
		Device dev2 = new  Device(250, 0, 1000, 1625);
		...
		Device dev11 = new Device(200, 0, 1000, 1625);
		Device dev12 = new Device(250, 0, 1000, 1625);
		...
		*/
		...
		scheduleGenerator = new ScheduleGenerator(true);
	    net = scheduleGenerator.deserializeNetwork(path);

	    System.out.println("\nFinished the first execution");
	    System.out.println("\nStarting execution 2");
	    
		Flow flow1 = new Flow(Flow.UNICAST);
		flow1.setStartDevice(net.getDevice("dev1"));
		flow1.addToPath((TSNSwitch) net.getSwitch("switch0"));
		flow1.addToPath((TSNSwitch) net.getSwitch("switch1"));
		flow1.setEndDevice(net.getDevice("dev9"));
		
		net.addElement(flow1, NetworkProperties.INCREMENTFLOW);		
		scheduleGenerator.generateSchedule(net);
		...
		flow2.setStartDevice(net.getDevice("dev2"));
		flow2.addToPath((TSNSwitch) net.getSwitch("switch0"));
		flow2.addToPath((TSNSwitch) net.getSwitch("switch1"));
		flow2.setEndDevice(net.getDevice("dev9"));
		
		net.addElement(flow2, NetworkProperties.INCREMENTFLOW);		
		scheduleGenerator.generateSchedule(net);
		...
		flow3.setStartDevice(net.getDevice("dev10"));
		flow3.addToPath((TSNSwitch) net.getSwitch("switch2"));
		flow3.addToPath((TSNSwitch) net.getSwitch("switch3"));
		flow3.setEndDevice(net.getDevice("dev19"));
		
		net.addElement(flow3, NetworkProperties.INCREMENTFLOW);		
		scheduleGenerator.generateSchedule(net);
		...
		flow4.setStartDevice(net.getDevice("dev11"));
		flow4.addToPath((TSNSwitch) net.getSwitch("switch2"));
		flow4.addToPath((TSNSwitch) net.getSwitch("switch3"));
		flow4.setEndDevice(net.getDevice("dev19"));
		
		net.addElement(flow4, NetworkProperties.INCREMENTFLOW);		
		scheduleGenerator.generateSchedule(net);
		...
		flow5.setStartDevice(net.getDevice("dev12"));
		flow5.addToPath((TSNSwitch) net.getSwitch("switch2"));
		flow5.addToPath((TSNSwitch) net.getSwitch("switch3"));
		flow5.setEndDevice(net.getDevice("dev18"));
		...
		flow6.setStartDevice(net.getDevice("dev20"));
		flow6.addToPath((TSNSwitch) net.getSwitch("switch4"));
		flow6.addToPath((TSNSwitch) net.getSwitch("switch5"));
		flow6.setEndDevice(net.getDevice("dev29"));
		
		net.addElement(flow6, NetworkProperties.INCREMENTFLOW);		
		scheduleGenerator.generateSchedule(net);
		...
		flow7.setStartDevice(net.getDevice("dev21"));
		flow7.addToPath((TSNSwitch) net.getSwitch("switch4"));
		flow7.addToPath((TSNSwitch) net.getSwitch("switch5"));
		flow7.setEndDevice(net.getDevice("dev29"));
		
		net.addElement(flow7, NetworkProperties.INCREMENTFLOW);		
		scheduleGenerator.generateSchedule(net);
		...
		flow8.setStartDevice(net.getDevice("dev22"));
		flow8.addToPath((TSNSwitch) net.getSwitch("switch4"));
		flow8.addToPath((TSNSwitch) net.getSwitch("switch5"));
		flow8.setEndDevice(net.getDevice("dev29"));
		
		net.addElement(flow8, NetworkProperties.INCREMENTFLOW);		
		scheduleGenerator.generateSchedule(net);
		...
		flow9.setStartDevice(net.getDevice("dev30"));
		flow9.addToPath((TSNSwitch) net.getSwitch("switch6"));
		flow9.addToPath((TSNSwitch) net.getSwitch("switch7"));
		flow9.setEndDevice(net.getDevice("dev39"));
		
		net.addElement(flow9, NetworkProperties.INCREMENTFLOW);		
		scheduleGenerator.generateSchedule(net);

		System.out.println("\nStarting execution 11");
		scheduleGenerator = new ScheduleGenerator(true);
	    net = scheduleGenerator.deserializeNetwork(path);

		Flow flow10 = new Flow(Flow.UNICAST);
		flow10.setStartDevice(net.getDevice("dev31"));
		flow10.addToPath((TSNSwitch) net.getSwitch("switch6"));
		flow10.addToPath((TSNSwitch) net.getSwitch("switch7"));
		flow10.setEndDevice(net.getDevice("dev39"));
		
		net.addElement(flow10, NetworkProperties.INCREMENTFLOW);		
		scheduleGenerator.generateSchedule(net);

		System.out.println("\nStarting execution 12");
		scheduleGenerator = new ScheduleGenerator(true);
	    net = scheduleGenerator.deserializeNetwork(path);

		Flow flow11 = new Flow(Flow.UNICAST);
		flow11.setStartDevice(net.getDevice("dev32"));
		flow11.addToPath((TSNSwitch) net.getSwitch("switch6"));
		flow11.addToPath((TSNSwitch) net.getSwitch("switch7"));
		flow11.setEndDevice(net.getDevice("dev39"));
		
		net.addElement(flow11, NetworkProperties.INCREMENTFLOW);		
		scheduleGenerator.generateSchedule(net);
		
		System.out.println("\nStarting execution 13");
		scheduleGenerator = new ScheduleGenerator(true);
	    net = scheduleGenerator.deserializeNetwork(path);

		Flow flow12 = new Flow(Flow.UNICAST);
		flow12.setStartDevice(net.getDevice("dev40"));
		flow12.addToPath((TSNSwitch) net.getSwitch("switch8"));
		flow12.addToPath((TSNSwitch) net.getSwitch("switch9"));
		flow12.setEndDevice(net.getDevice("dev49"));
		
		net.addElement(flow12, NetworkProperties.INCREMENTFLOW);		
		scheduleGenerator.generateSchedule(net);

		System.out.println("\nStarting execution 14");
		scheduleGenerator = new ScheduleGenerator(true);
	    net = scheduleGenerator.deserializeNetwork(path);

		Flow flow13 = new Flow(Flow.UNICAST);
		flow13.setStartDevice(net.getDevice("dev41"));
		flow13.addToPath((TSNSwitch) net.getSwitch("switch8"));
		flow13.addToPath((TSNSwitch) net.getSwitch("switch9"));
		flow13.setEndDevice(net.getDevice("dev49"));
		
		net.addElement(flow13, NetworkProperties.INCREMENTFLOW);		
		scheduleGenerator.generateSchedule(net);

		System.out.println("\nStarting execution 15");
		scheduleGenerator = new ScheduleGenerator(true);
	    net = scheduleGenerator.deserializeNetwork(path);

		Flow flow14 = new Flow(Flow.UNICAST);
		flow14.setStartDevice(net.getDevice("dev42"));
		flow14.addToPath((TSNSwitch) net.getSwitch("switch8"));
		flow14.addToPath((TSNSwitch) net.getSwitch("switch9"));
		flow14.setEndDevice(net.getDevice("dev49"));
		
		net.addElement(flow14, NetworkProperties.INCREMENTFLOW);		
		scheduleGenerator.generateSchedule(net);
		...
		System.out.println("Time taken schedule all flows: " + ((float) totalTime)/1000000000 + " seconds\n ");
	}
}