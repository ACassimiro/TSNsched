...
public class GeneratedCode {
	public void runTestCase(){
		...
		*/
		...
		PathNode pathNode0;
		pathNode0 = pathTree0.addRoot(dev32);
		...
		PathNode pathNode1;
		pathNode1 = pathTree1.addRoot(dev12);
		pathNode1 = pathNode1.addChild(switch2);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode2;
		pathNode2 = pathTree2.addRoot(dev9);
		...
		nodeList.add(nodeList.getFirst().addChild(switch6));
		nodeList.add(nodeList.removeFirst().addChild(switch9));
		nodeList.add(nodeList.removeFirst().addChild(switch8));
		nodeList.getFirst().addChild(dev30);
		nodeList.getFirst().addChild(dev31);
		...
		PathNode pathNode5;
		pathNode5 = pathTree5.addRoot(dev36);
		pathNode5 = pathNode5.addChild(switch7);
		nodeList = new LinkedList<PathNode>();
		...
		nodeList.add(nodeList.removeFirst().addChild(switch2));
		nodeList.add(nodeList.removeFirst().addChild(switch3));
		nodeList.add(nodeList.getFirst().addChild(switch0));
		nodeList.add(nodeList.removeFirst().addChild(switch7));
		nodeList.add(nodeList.removeFirst().addChild(switch1));
		nodeList.getFirst().addChild(dev0);
		nodeList.getFirst().addChild(dev1);
		...
		PathNode pathNode7;
		pathNode7 = pathTree7.addRoot(dev42);
		pathNode7 = pathNode7.addChild(switch8);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode8;
		pathNode8 = pathTree8.addRoot(dev2);
		pathNode8 = pathNode8.addChild(switch0);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode9;
		pathNode9 = pathTree9.addRoot(dev15);
		pathNode9 = pathNode9.addChild(switch3);
		nodeList = new LinkedList<PathNode>();
		...
		*/
		...
		System.out.println("Number of subscribers in the network: 138 ");
