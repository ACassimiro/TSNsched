...
public class GeneratedCode {
	public void runTestCase(){
		...
		*/
		...
		PathNode pathNode0;
		pathNode0 = pathTree0.addRoot(dev28);
		...
		PathNode pathNode1;
		pathNode1 = pathTree1.addRoot(dev34);
		pathNode1 = pathNode1.addChild(switch6);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode2;
		pathNode2 = pathTree2.addRoot(dev30);
		...
		*/
		...
		System.out.println("Number of subscribers in the network: 40 ");
