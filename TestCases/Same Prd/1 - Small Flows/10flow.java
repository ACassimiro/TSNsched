...
public class GeneratedCode {
	public void runTestCase(){
		...
		*/
		...
		PathNode pathNode1;
		pathNode1 = pathTree1.addRoot(dev45);
		...
		PathNode pathNode2;
		pathNode2 = pathTree2.addRoot(dev27);
		pathNode2 = pathNode2.addChild(switch5);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode3;
		pathNode3 = pathTree3.addRoot(dev28);
		...
		PathNode pathNode4;
		pathNode4 = pathTree4.addRoot(dev29);
		...
		PathNode pathNode5;
		pathNode5 = pathTree5.addRoot(dev0);
		pathNode5 = pathNode5.addChild(switch0);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode6;
		pathNode6 = pathTree6.addRoot(dev4);
		pathNode6 = pathNode6.addChild(switch0);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode7;
		pathNode7 = pathTree7.addRoot(dev20);
		...
		PathNode pathNode8;
		pathNode8 = pathTree8.addRoot(dev46);
		pathNode8 = pathNode8.addChild(switch9);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode9;
		pathNode9 = pathTree9.addRoot(dev38);
		pathNode9 = pathNode9.addChild(switch7);
		nodeList = new LinkedList<PathNode>();
		...
		*/
		...
		System.out.println("Number of subscribers in the network: 41 ");
