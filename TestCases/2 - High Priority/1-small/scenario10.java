...
public class GeneratedCode {
	public void runTestCase(){
		...
		*/
		...
		PathNode pathNode1;
		pathNode1 = pathTree1.addRoot(dev9);
		...
		PathNode pathNode2;
		pathNode2 = pathTree2.addRoot(dev17);
		pathNode2 = pathNode2.addChild(switch3);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode3;
		pathNode3 = pathTree3.addRoot(dev18);
		pathNode3 = pathNode3.addChild(switch3);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode4;
		pathNode4 = pathTree4.addRoot(dev25);
		pathNode4 = pathNode4.addChild(switch5);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode5;
		pathNode5 = pathTree5.addRoot(dev28);
		pathNode5 = pathNode5.addChild(switch5);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode6;
		pathNode6 = pathTree6.addRoot(dev44);
		pathNode6 = pathNode6.addChild(switch8);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode7;
		pathNode7 = pathTree7.addRoot(dev19);
		pathNode7 = pathNode7.addChild(switch3);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode9;
		pathNode9 = pathTree9.addRoot(dev12);
		pathNode9 = pathNode9.addChild(switch2);
		nodeList = new LinkedList<PathNode>();
		...
		nodeList.getFirst().addChild(dev43);
		nodeList.getFirst().addChild(dev44);
		nodeList.removeFirst();
		...
		*/
		...
		System.out.println("Number of subscribers in the network: 45 ");
