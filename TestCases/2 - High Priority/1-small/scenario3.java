...
public class GeneratedCode {
	public void runTestCase(){
		...
		*/
		...
		PathNode pathNode0;
		pathNode0 = pathTree0.addRoot(dev7);
		pathNode0 = pathNode0.addChild(switch1);
		...
		PathNode pathNode1;
		pathNode1 = pathTree1.addRoot(dev43);
		pathNode1 = pathNode1.addChild(switch8);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode2;
		pathNode2 = pathTree2.addRoot(dev2);
		...
		*/
		...
		System.out.println("Number of subscribers in the network: 13 ");
