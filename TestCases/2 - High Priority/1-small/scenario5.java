...
public class GeneratedCode {
	public void runTestCase(){
		...
		*/
		...
		PathNode pathNode0;
		pathNode0 = pathTree0.addRoot(dev21);
		...
		PathNode pathNode2;
		pathNode2 = pathTree2.addRoot(dev23);
		pathNode2 = pathNode2.addChild(switch4);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode3;
		pathNode3 = pathTree3.addRoot(dev32);
		pathNode3 = pathNode3.addChild(switch6);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode4;
		pathNode4 = pathTree4.addRoot(dev10);
		pathNode4 = pathNode4.addChild(switch2);
		nodeList = new LinkedList<PathNode>();
		...
		*/
		...
		System.out.println("Number of subscribers in the network: 21 ");
