...
public class GeneratedCode {
	public void runTestCase(){
		...
		*/
		...
		PathNode pathNode1;
		pathNode1 = pathTree1.addRoot(dev49);
		pathNode1 = pathNode1.addChild(switch9);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode2;
		pathNode2 = pathTree2.addRoot(dev0);
		pathNode2 = pathNode2.addChild(switch0);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode3;
		pathNode3 = pathTree3.addRoot(dev7);
		...
		PathNode pathNode4;
		pathNode4 = pathTree4.addRoot(dev5);
		...
		*/
		...
		System.out.println("Number of subscribers in the network: 69 ");
