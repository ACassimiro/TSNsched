...
public class GeneratedCode {
	public void runTestCase(){
		...
		*/
		...
		nodeList.add(nodeList.removeFirst().addChild(switch9)); // 1
		nodeList.add(nodeList.getFirst().addChild(switch0)); // 2
		nodeList.add(nodeList.removeFirst().addChild(switch3)); // 3
		nodeList.add(nodeList.getFirst().addChild(switch7)); // 2
		nodeList.add(nodeList.removeFirst().addChild(switch2)); // 3
		nodeList.add(nodeList.removeFirst().addChild(switch1)); // 1
		nodeList.getFirst().addChild(dev35);
		nodeList.getFirst().addChild(dev36);
		nodeList.getFirst().addChild(dev37);
		nodeList.getFirst().addChild(dev38);
		...
		nodeList.getFirst().addChild(dev7);
		nodeList.getFirst().addChild(dev8);
		nodeList.getFirst().addChild(dev9);
		nodeList.removeFirst();
		...
		PathNode pathNode1;
		pathNode1 = pathTree1.addRoot(dev0);
		pathNode1 = pathNode1.addChild(switch0);
		nodeList = new LinkedList<PathNode>();
		nodeList.add(pathNode1);
		nodeList.add(nodeList.getFirst().addChild(switch1)); // 2
		nodeList.add(nodeList.removeFirst().addChild(switch5)); // 3
		nodeList.add(nodeList.getFirst().addChild(switch2)); // 2
		nodeList.add(nodeList.removeFirst().addChild(switch4)); // 3
		nodeList.add(nodeList.getFirst().addChild(switch6)); // 2
		nodeList.add(nodeList.removeFirst().addChild(switch9)); // 3
		nodeList.getFirst().addChild(dev10);
		nodeList.getFirst().addChild(dev11);
		nodeList.getFirst().addChild(dev12);
		nodeList.removeFirst();
		...
		PathNode pathNode2;
		pathNode2 = pathTree2.addRoot(dev5);
		pathNode2 = pathNode2.addChild(switch1);
		nodeList = new LinkedList<PathNode>();
		nodeList.add(pathNode2);
		nodeList.add(nodeList.getFirst().addChild(switch3)); // 2
		nodeList.add(nodeList.removeFirst().addChild(switch8)); // 3
		nodeList.add(nodeList.getFirst().addChild(switch9)); // 2
		nodeList.add(nodeList.removeFirst().addChild(switch6)); // 3
		nodeList.add(nodeList.removeFirst().addChild(switch5)); // 1
		nodeList.add(nodeList.removeFirst().addChild(switch4)); // 1
		nodeList.getFirst().addChild(dev30);
		nodeList.getFirst().addChild(dev31);
		nodeList.getFirst().addChild(dev32);
		...
		nodeList.getFirst().addChild(dev21);
		nodeList.getFirst().addChild(dev22);
		nodeList.getFirst().addChild(dev23);
		nodeList.getFirst().addChild(dev24);
		nodeList.removeFirst();
		...
		PathNode pathNode3;
		pathNode3 = pathTree3.addRoot(dev44);
		pathNode3 = pathNode3.addChild(switch8);
		nodeList = new LinkedList<PathNode>();
		nodeList.add(pathNode3);
		nodeList.add(nodeList.removeFirst().addChild(switch3)); // 1
		nodeList.add(nodeList.getFirst().addChild(switch7)); // 2
		nodeList.add(nodeList.removeFirst().addChild(switch1)); // 3
		nodeList.add(nodeList.getFirst().addChild(switch9)); // 2
		nodeList.add(nodeList.removeFirst().addChild(switch6)); // 3
		nodeList.add(nodeList.removeFirst().addChild(switch0)); // 1
		nodeList.getFirst().addChild(dev45);
		nodeList.getFirst().addChild(dev46);
		nodeList.getFirst().addChild(dev47);
		nodeList.getFirst().addChild(dev48);
		...
		PathNode pathNode4;
		pathNode4 = pathTree4.addRoot(dev33);
		pathNode4 = pathNode4.addChild(switch6);
		nodeList = new LinkedList<PathNode>();
		nodeList.add(pathNode4);
		nodeList.add(nodeList.getFirst().addChild(switch8)); // 2
		nodeList.add(nodeList.removeFirst().addChild(switch0)); // 3
		nodeList.add(nodeList.getFirst().addChild(switch9)); // 2
		nodeList.add(nodeList.removeFirst().addChild(switch3)); // 3
		nodeList.add(nodeList.getFirst().addChild(switch4)); // 2
		nodeList.add(nodeList.removeFirst().addChild(switch2)); // 3
		nodeList.getFirst().addChild(dev45);
		nodeList.getFirst().addChild(dev46);
		nodeList.getFirst().addChild(dev47);
		...
		PathNode pathNode5;
		pathNode5 = pathTree5.addRoot(dev10);
		pathNode5 = pathNode5.addChild(switch2);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode6;
		pathNode6 = pathTree6.addRoot(dev26);
		pathNode6 = pathNode6.addChild(switch5);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode7;
		pathNode7 = pathTree7.addRoot(dev30);
		pathNode7 = pathNode7.addChild(switch6);
		nodeList = new LinkedList<PathNode>();
		nodeList.add(pathNode7);
		nodeList.add(nodeList.getFirst().addChild(switch0)); // 2
		nodeList.add(nodeList.removeFirst().addChild(switch4)); // 3
		nodeList.add(nodeList.getFirst().addChild(switch5)); // 2
		nodeList.add(nodeList.removeFirst().addChild(switch8)); // 3
		nodeList.add(nodeList.getFirst().addChild(switch1)); // 2
		nodeList.add(nodeList.removeFirst().addChild(switch7)); // 3
		nodeList.getFirst().addChild(dev25);
		nodeList.getFirst().addChild(dev26);
		nodeList.getFirst().addChild(dev27);
		nodeList.removeFirst();
		...
		nodeList.getFirst().addChild(dev42);
		nodeList.removeFirst();
		nodeList.getFirst().addChild(dev5);
		nodeList.getFirst().addChild(dev6);
		nodeList.getFirst().addChild(dev7);
		...
		PathNode pathNode8;
		pathNode8 = pathTree8.addRoot(dev35);
		pathNode8 = pathNode8.addChild(switch7);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode9;
		pathNode9 = pathTree9.addRoot(dev1);
		pathNode9 = pathNode9.addChild(switch0);
		nodeList = new LinkedList<PathNode>();
		...
		nodeList.add(nodeList.getFirst().addChild(switch9)); // 2
		nodeList.add(nodeList.removeFirst().addChild(switch1)); // 3
		nodeList.add(nodeList.removeFirst().addChild(switch2)); // 1
		nodeList.add(nodeList.removeFirst().addChild(switch4)); // 1
		nodeList.getFirst().addChild(dev5);
		nodeList.getFirst().addChild(dev6);
		nodeList.getFirst().addChild(dev7);
		...
		*/
		...
		System.out.println("Number of flows in the network: 10 ");
		System.out.println("Number of subscribers in the network: 144 ");
