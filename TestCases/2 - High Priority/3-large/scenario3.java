...
public class GeneratedCode {
	public void runTestCase(){
		...
		*/
		...
		PathNode pathNode0;
		pathNode0 = pathTree0.addRoot(dev20);
		...
		PathNode pathNode1;
		pathNode1 = pathTree1.addRoot(dev8);
		...
		PathNode pathNode2;
		pathNode2 = pathTree2.addRoot(dev47);
		pathNode2 = pathNode2.addChild(switch9);
		nodeList = new LinkedList<PathNode>();
		...
		*/
		...
		System.out.println("Number of subscribers in the network: 44 ");
