...
public class GeneratedCode {
	public void runTestCase(){
		...
		*/
		...
		PathNode pathNode0;
		pathNode0 = pathTree0.addRoot(dev33);
		...
		PathNode pathNode1;
		pathNode1 = pathTree1.addRoot(dev47);
		...
		PathNode pathNode2;
		pathNode2 = pathTree2.addRoot(dev31);
		pathNode2 = pathNode2.addChild(switch6);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode3;
		pathNode3 = pathTree3.addRoot(dev8);
		...
		PathNode pathNode4;
		pathNode4 = pathTree4.addRoot(dev3);
		pathNode4 = pathNode4.addChild(switch0);
		nodeList = new LinkedList<PathNode>();
		...
		*/
		...
		System.out.println("Number of subscribers in the network: 46 ");
