...
public class GeneratedCode {
	public void runTestCase(){
		...
		*/
		...
		PathNode pathNode0;
		pathNode0 = pathTree0.addRoot(dev30);
		pathNode0 = pathNode0.addChild(switch6);
		nodeList = new LinkedList<PathNode>();
		nodeList.add(pathNode0);
		nodeList.add(nodeList.removeFirst().addChild(switch8)); // 1
		...
		PathNode pathNode1;
		pathNode1 = pathTree1.addRoot(dev24);
		...
		nodeList.add(nodeList.removeFirst().addChild(switch7)); // 1
		...
		PathNode pathNode2;
		pathNode2 = pathTree2.addRoot(dev40);
		...
		PathNode pathNode3;
		pathNode3 = pathTree3.addRoot(dev14);
		pathNode3 = pathNode3.addChild(switch2);
		nodeList = new LinkedList<PathNode>();
		...
		nodeList.add(nodeList.removeFirst().addChild(switch9)); // 3
		nodeList.add(nodeList.removeFirst().addChild(switch6)); // 1
		...
		PathNode pathNode4;
		pathNode4 = pathTree4.addRoot(dev39);
		pathNode4 = pathNode4.addChild(switch7);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode5;
		pathNode5 = pathTree5.addRoot(dev49);
		pathNode5 = pathNode5.addChild(switch9);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode6;
		pathNode6 = pathTree6.addRoot(dev13);
		pathNode6 = pathNode6.addChild(switch2);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode7;
		pathNode7 = pathTree7.addRoot(dev23);
		pathNode7 = pathNode7.addChild(switch4);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode8;
		pathNode8 = pathTree8.addRoot(dev12);
		pathNode8 = pathNode8.addChild(switch2);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode9;
		pathNode9 = pathTree9.addRoot(dev47);
		pathNode9 = pathNode9.addChild(switch9);
		nodeList = new LinkedList<PathNode>();
		...
		*/
		...
		System.out.println("Number of subscribers in the network: 91 ");
