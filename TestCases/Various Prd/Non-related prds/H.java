...
public class GeneratedCode {
	public void runTestCase(){
		...
		* GENERATING DEVICES
		*/
		Device dev0 = new Device(550, 0, 1000, 0, 100);
		Device dev1 = new Device(800, 0, 1000, 0, 100);
		Device dev2 = new Device(300, 0, 1000, 0, 100);
		Device dev3 = new Device(700, 0, 1000, 0, 100);
		...
		*/
		...
		switch0.createPort(dev5, cycle95);
		...
		*/
		...
		overallAverageLatency = overallAverageLatency/4;
		overallAverageJitter = overallAverageJitter/4;

		System.out.println("\nNumber of nodes in the network: 1 ");
		System.out.println("Number of flows in the network: 4 ");
