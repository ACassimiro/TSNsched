...
public class GeneratedCode {
	public void runTestCase(){
		...
		*/
		...
		PathNode pathNode0;
		pathNode0 = pathTree0.addRoot(dev14);
		pathNode0 = pathNode0.addChild(switch2);
		...
		PathNode pathNode2;
		pathNode2 = pathTree2.addRoot(dev38);
		...
		PathNode pathNode3;
		pathNode3 = pathTree3.addRoot(dev4);
		pathNode3 = pathNode3.addChild(switch0);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode5;
		pathNode5 = pathTree5.addRoot(dev18);
		pathNode5 = pathNode5.addChild(switch3);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode6;
		pathNode6 = pathTree6.addRoot(dev27);
		...
		PathNode pathNode7;
		pathNode7 = pathTree7.addRoot(dev12);
		pathNode7 = pathNode7.addChild(switch2);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode8;
		pathNode8 = pathTree8.addRoot(dev15);
		pathNode8 = pathNode8.addChild(switch3);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode9;
		pathNode9 = pathTree9.addRoot(dev48);
		...
		*/
		...
		System.out.println("Number of subscribers in the network: 147 ");
