...
public class GeneratedCode {
	public void runTestCase(){
		...
		*/
		...
		PathNode pathNode0;
		pathNode0 = pathTree0.addRoot(dev0);
		...
		PathNode pathNode1;
		pathNode1 = pathTree1.addRoot(dev14);
		...
		PathNode pathNode2;
		pathNode2 = pathTree2.addRoot(dev16);
		...
		PathNode pathNode3;
		pathNode3 = pathTree3.addRoot(dev36);
		pathNode3 = pathNode3.addChild(switch7);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode4;
		pathNode4 = pathTree4.addRoot(dev41);
		pathNode4 = pathNode4.addChild(switch8);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode5;
		pathNode5 = pathTree5.addRoot(dev25);
		...
		PathNode pathNode6;
		pathNode6 = pathTree6.addRoot(dev35);
		pathNode6 = pathNode6.addChild(switch7);
		nodeList = new LinkedList<PathNode>();
		...
		PathNode pathNode8;
		pathNode8 = pathTree8.addRoot(dev42);
		pathNode8 = pathNode8.addChild(switch8);
		nodeList = new LinkedList<PathNode>();
